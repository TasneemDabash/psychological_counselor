...
class AppColors {
  /// App primary color
  static const Color primary = Color(0xFFFB8A00); // Primary gradient start
  static const Color tertiary = Color(0xFFFFE4C2); // Primary gradient start
  ...
  static const Color userChatColor = Color(0xFFFFE4C2);
