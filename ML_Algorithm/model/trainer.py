...
from sklearn.ensemble import (
    ...
    StackingRegressor, BaggingRegressor, VotingRegressor, AdaBoostRegressor, ExtraTreesRegressor
)
...
def train_models(X_train, y_train, X_test, y_test, scaler):
    models = {
        ...
        "SVR": SVR(kernel='poly', degree=3, C=30, epsilon=0.05, gamma='scale'),
    ...
    for name, model in models.items():
        ...
        results[name] = (mae, rmse, mse, r2, acc)
